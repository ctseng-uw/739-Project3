...
async def test_write_to_backup(
    ...
    with pytest.raises(ProcessError):
        assert (await client.write(1, 8192, "write_to_node1")).stderr == "This server is backup"
...
async def test_primary_network_down(
    ...
    assert (await client.write_any(8192, "change_when_node0_out_of_reach")).stderr == "Write to node1"
